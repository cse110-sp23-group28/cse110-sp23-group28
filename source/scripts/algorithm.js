...
function getScore(name1, name2, bday1, bday2) {
    ...
    //     [_, 0.86, 0.23, 0.91, 0.29, 0.73, 0.33, 0.89, 0.31, 0.89, 0.11, 0.88],
    //     [_, _, 0.83, 0.21, 0.82, 0.4, 0.78, 0.15, 0.92, 0.15, 0.85, 0.1],
    //     [_, _, _, 0.85, 0.29, 0.77, 0.28, 0.79, 0.27, 0.84, 0.31, 0.72],
    //     [_, _, _, _, 0.78, 0.35, 0.75, 0.29, 0.75, 0.27, 0.89, 0.14],
    //     [_, _, _, _, _, 0.65, 0.3, 0.76, 0.32, 0.77, 0.3, 0.86],
    //     [_, _, _, _, _, _, 0.68, 0.29, 0.71, 0.34, 0.68, 0.29],
    //     [_, _, _, _, _, _, _, 0.66, 0.3, 0.64, 0.3, 0.8],
    //     [_, _, _, _, _, _, _, _, 0.74, 0.38, 0.83, 0.5],
    //     [_, _, _, _, _, _, _, _, _, 0.62, 0.37, 0.76],
    //     [_, _, _, _, _, _, _, _, _, _, 0.74, 0.38],
    //     [_, _, _, _, _, _, _, _, _, _, _, 0.73],
    // ]

    // Missing values filled in with ChatGPT
    const ZODIAC_COMPATIBILITIES = [
        [0.75, 0.63, 0.74, 0.47, 0.83, 0.42, 0.62, 0.99, 0.87, 0.38, 0.99, 0.29],
